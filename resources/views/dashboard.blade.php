                                ...
                                <div class="card mb-30 progress_1">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-wrap mb-2 progress-info">
                                            <div>Users</div>
                                            <div><img src="assets/img/svg/caret-up.svg" alt="" class="svg">
                                                2.6k</div>
                                            <div><img src="assets/img/svg/caret-down.svg" alt=""
                                                    class="svg">568</div>
                                        </div>
                                        ...
                                        <div class="d-flex flex-wrap progress-info">
                                            <div>Disabled</div>
                                            <div><img src="assets/img/svg/caret-up.svg" alt=""
                                                    class="svg">1.26k</div>
                                            <div><img src="assets/img/svg/caret-down.svg" alt=""
                                                    class="svg">25</div>
                                        </div>
                            ...
                            <div class="col-md-4 col-sm-6">
                                ...
                                <div class="card mb-30 progress_3 mr-0">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-wrap mb-2 progress-info">
                                            <div>Employee</div>
                                            <div><img src="assets/img/svg/caret-up.svg" alt="" class="svg">15
                                            </div>
                                            <div><img src="assets/img/svg/caret-down.svg" alt="" class="svg">3
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body p-0">
                                            ...
                                            <div class="d-flex justify-content-between align-items-start mb-2">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <a href="pages/apps/todolist/add-new.html" class="btn-circle">
                                                        <img src="assets/img/svg/plus_white.svg" alt=""
                                                            class="svg">
                                                    </a>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="d-flex position-relative">
                                                    ...
                                                    <div class="todo-text line-through">
                                                        <p class="card-text mb-1">For detracty charmed add talking
                                                            age. Shy resolution instrument unreserved man few.</p>
                                                        <p class="text-warning font-12 mb-0">Urgent Not Important
                                                        </p>
                                                    </div>
                                                    <!-- End Todo Text -->
                                                </div>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="assign_to">
                                                        ...
                                                        <div class="assign-content">
                                                            ...
                                                            <img src="assets/img/avatar/info-avatar.png" alt=""
                                                                class="assign-avatar">
                                                        </div>
                                                    </div>
                                                    <!-- End Assign To -->
                                        ...
                                        <div class="single-row border-bottom pt-3 pb-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="d-flex position-relative">
                                                    ...
                                                    <!-- Todo Text -->
                                                    <div class="todo-text">
                                                        <p class="card-text mb-1">Way sentiments two indulgence
                                                            uncommonly own.</p>
                                                        <p class="text-danger font-12 mb-0">Urgent And Important
                                                        </p>
                                                    </div>
                                                    <!-- End Todo Text -->
                                                </div>
                                        ...
                                        <div class="single-row border-bottom pt-3 pb-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="d-flex position-relative">
                                                    ...
                                                    <!-- Todo Text -->
                                                    <div class="todo-text">
                                                        <p class="card-text mb-1">Donec dapibus mauris id odio
                                                            ornare tempus amet.</p>
                                                        <p class="text-success font-12 mb-0">Not Urgent Or
                                                            Important</p>
                                                    </div>
                                                    <!-- End Todo Text -->
                                                </div>
                                        ...
                                        <div class="single-row border-bottom pt-3 pb-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="d-flex">
                                                    <!-- Drag Icon -->
                                                    <img src="assets/img/svg/dragicon.svg" alt=""
                                                        class="svg mr-2">
                                                    <!-- End Drag Icon -->
                                                    <!-- Assign To -->
                                                    <div class="assign_to">
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-7 col-sm-6 col-lg-7">
                                        <div class="">
                                            ...
                                            <p>Pellentesque tincidunt tristique neque, eget venenatis enim gravida.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="d-flex justify-content-start progress_5">
                                            <div class="ProgressBar-wrap2 position-relative">
                                                <div class="ProgressBar ProgressBar_5" data-progress="48">
                                                    ...
                                                    <span
                                                        class="ProgressBar-percentage ProgressBar-percentage--count style--two"></span>
                        ...
                        <div class="card mb-30">
                            <div class="card-body">
                                <div class="mb-1">
                                    ...
                                    <p class="pt-1">Nunc scelerisque tincidunt elit. Vestibulum non mi ipsum.
                                        Cras pretium suscipit tellus sit amet aliquet. Vestibulum maximus lacinia
                                        massa non porttitor. </p>
                                </div>
